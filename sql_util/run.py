...
def execute_query_with_cache(db_path: str, query: str):
    """
    Cached version of query execution.
    """
    return exec_db_path_(db_path, query)
...
def get_result_set(queries: List[str],
    ...
    #             exit(0)
        ...
        print(f"Error in get_result_set: {e}")
        return None
